...
namespace Programa.ConsoleService
{
    ...
    public class ParamTypeValidator
    {
        ...
        public bool Validate(string[] args, params Type[] types)
        {
        ...
        public bool Validate<T>(string[] args)
        {
            Contract.Requires(args != null, "args is null");
            return this.Validate(args, typeof(T));
        }
        ...
        /// </returns>
        public bool Validate<T1, T2>(string[] args)
        {
            Contract.Requires(args != null, "args is null");
            return this.Validate(args, typeof(T1), typeof(T2));
        }
    }
}
